...
To avoid overfitting and to estimate out of sample error cleaned training data will be splitted into train and test parts (60%/40% respectively).
```{r cross,echo=TRUE}
